...
var Map = function Map() {
  ...
  var handleClick = function handleClick(selectedMapIdx, properties) {
    var regions = selectedMapIdx >= 0 && selectedMapIdx <= 3; // const href = `/${regions ? 'regions' : 'departements'}/${regions ? 'regions' : 'departements'}?code=${properties.code.slice(4)}`

    var as = "/".concat(regions ? 'regions' : 'departements', "/").concat(properties.code.slice(4));
    next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push(as);
  };
...
//# sourceMappingURL=index.js.6db257dd8f1e5e27e70b.hot-update.js.map