...
var Map = function Map() {
  ...
  var handleClick = function handleClick(selectedMapIdx, properties) {
    ...
    var departements = selectedMapIdx >= 4 && selectedMapIdx <= 7;
    var href = '';
    var as = '';
    href = "/".concat(regions ? 'regions' : 'departements', "/").concat(regions ? 'regions' : 'departements', "?code=").concat(properties.code);
    as = "/".concat(regions ? 'regions' : 'departements', "/").concat(properties.code);
...
//# sourceMappingURL=index.js.1994d2f401e7a48d5e7e.hot-update.js.map